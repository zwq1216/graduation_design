...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sno', models.CharField(max_length=20, unique=True, verbose_name='学号/工号')),
                ('name', models.CharField(max_length=50, verbose_name='学院名称')),
                ('no', models.CharField(max_length=30, unique=True, verbose_name='所属编号')),
            ],
            options={
                'verbose_name': '注册信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='community.Community', verbose_name='所属社团')),
            ],
            options={
                'verbose_name': '社团积分',
                'verbose_name_plural': '社团积分',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('score', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Score', verbose_name='所属积分')),
